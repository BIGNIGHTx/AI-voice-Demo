        ...
        <div className="max-w-full mx-auto">
          ...
          <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-center">
            <div className="flex items-center gap-4 sm:gap-5">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight text-slate-800 sm:text-3xl">Files Library</h1>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              ...
              <div className="text-right">
                <div className="text-2xl font-black tracking-tight text-indigo-600 sm:text-3xl">{filteredFiles.length.toLocaleString()}</div>
